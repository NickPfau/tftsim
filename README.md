...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/nickpfau/tftsim/main)

Simulate games of TFT(Teamfight Tactics)
...
git branch -M main
git remote add origin https://github.com/nickpfau/tftsim.git
